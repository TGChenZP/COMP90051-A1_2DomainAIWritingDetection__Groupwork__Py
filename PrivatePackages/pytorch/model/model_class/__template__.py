...
class ClassificationModel(object):
    ...
    def fit(self, total_train_X, total_train_y, total_train_domain, total_val_X, total_val_y, total_val_domain):
        ...
        for epoch in range(self.configs.epochs):
            ...
            if epoch_bal_accu >= max_bal_accuracy:
                max_bal_accuracy = epoch_bal_accu
                best_epoch = epoch
                self.save()
...
class DANN_Model(object):
    ...
    def fit(self, total_train_X, total_train_y, total_train_domain, total_val_X, total_val_y, total_val_domain):
        ...
        for epoch in range(self.configs.epochs):
            ...
            # print epoch training results
            epoch_pred_label = [1 if i[1] > i[0] else 0 for i in epoch_dom_pred]
            epoch_label = [1 if i[1] > i[0] else 0 for i in epoch_true]
            ...
            record = f'''Epoch {epoch+1} Train | Classification Loss: {epoch_classifcation_loss:>7.4f} | Accuracy: {epoch_accuracy:>7.4f}| F1: {epoch_f1:>7.4f} | Balanced Accuracy: {epoch_bal_accu:>7.4f} | 
    ...
    def eval(self, total_val_X, total_val_y, total_val_domain, epoch, evaluation_mode = False):
        ...
        record = f'''Epoch {epoch+1} Val   | Classification Loss: {epoch_loss:>7.4f} | Accuracy: {epoch_accuracy:>7.4f}| F1: {epoch_f1:>7.4f} | Balanced Accuracy: {epoch_bal_accu:>7.4f} |  
